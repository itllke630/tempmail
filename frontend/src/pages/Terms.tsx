  ...
  return (
    ...
    <div>
      <div className="max-w-[1400px] ">
        <p className="mt-8">
          Welcome to TempMail! These Terms of Service ("Terms") govern your
        ...
        <p className="mt-4">
          TempMail is a minimalistic temporary email service that allows you to
          ...
          TempMail operates on the Cloudflare network, guaranteeing a
        ...
        <p className="mt-4">
          2.1 Availability: Please note that TempMail is not available in China
          Mainland. We apologize for any inconvenience caused.
        </p>
        <p className="mt-4">
          2.2 Copyright: All copyrights related to TempMail and its services
          belong to TempMail. You may not copy, reproduce, distribute, modify,
          or create derivative works of TempMail or any part thereof without
          explicit permission from TempMail.
        </p>
        ...
        <p className="mt-4">
          ...
          personal information to use TempMail. However, you are solely
          responsible for maintaining the confidentiality of any temporary email
          addresses generated through our service.
        </p>
        <p className="mt-4">
          3.2 Prohibited Activities: While using TempMail, you agree not to
        ...
        <p className="mt-4">
          TempMail is provided on an "as is" and "as available" basis. We do
          not warrant that our services will be uninterrupted, error-free, or
          secure. Your use of TempMail is at your own risk, and we disclaim all
        ...
        <p className="mt-4">
          To the maximum extent permitted by law, in no event shall TempMail or
          ...
          from your access to or use of TempMail or any content or services
          provided through TempMail.
        </p>
        ...
        <p className="mt-4">
          ...
          posting. Your continued use of TempMail after the posting of any
        ...
        <p className="mt-4">
          ...
          laws of the jurisdiction where TempMail is located. Any disputes
